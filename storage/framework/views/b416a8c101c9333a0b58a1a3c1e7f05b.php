<ul class="nav nav-pills nav-main" id="mainMenu">
    <li class="dropdown mega-menu-item mega-menu-fullwidth">
        <a class="dropdown-toggle" href="#"> <?php echo e(__('Giới thiệu')); ?> <i class="fa fa-caret-down"></i></a>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <ul class="sub-menu menu-border">
                                <li>
                                    <span class="mega-menu-sub-title"><?php echo e(__('Trường Đại học An Giang')); ?></span>
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/tong-quan-ve-truong-dai-hoc-an-giang">Tổng quan về Trường Đại học An Giang</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/so-do-to-chuc">Sơ đồ tổ chức</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/dang-uy">Đảng ủy</a></li>
                                        
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/ban-giam-hieu">Ban Giám hiệu</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/hoi-dong-khoa-hoc">Hội đồng Khoa học</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/su-mang-tam-nhin-gia-tri-cot-loi">Sứ mạng - Tầm nhìn - Giá trị cốt lõi - Triết lý giáo dục - Bản sắc người học</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/chinh-sach-dam-bao-chat-luong-phuong-cham-hoat-dong">Chính sách đảm bảo chất lượng - Phương châm hoạt động</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/ke-hoach-chien-luoc">Kế hoạch chiến lược</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/brochure">Brochure</a></li>
                        ...
                        <div class="col-md-3">
                            <ul class="sub-menu menu-border">
                                <li>
                                    <span class="mega-menu-sub-title"><?php echo e(__('Thông tin chung')); ?></span>
                                    <ul class="sub-menu">
                                        <li><a href="https://25years.agu.edu.vn/" target="_blank">Kỷ niệm 25 năm thành lập Trường</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/logo-ky-niem-25-nam-thanh-lap-truong">Logo kỷ niệm 25 năm thành lập Trường</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/bao-cao-thuong-nien">Báo cáo thường niên</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/dai-hoc-an-giang-theo-dong-thoi-gian">Trường ĐHAG theo dòng thời gian</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/video-gioi-thieu">Video giới thiệu về Trường ĐHAG</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?>20years" target="_blanks">20 năm Trường Đại học An Giang</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/bai-hat-dhag-truong-chung-toi">Bài hát “ĐHAG Trường Chúng Tôi”</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/dhag-qua-goc-nhin-flycam">Trường ĐHAG qua góc nhìn Flycam</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/hinh-anh-hoat-dong">Thư viện ảnh</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/van-ban-quan-ly-dieu-hanh">Văn bản Quản lý - Điều hành</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/phat-trien-ben-vung">Phát triển bền vững</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/gioi-thieu/lien-he">Liên hệ</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-3">
                            <ul class="sub-menu menu-border">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/tin-moi-nhat">Tin mới nhất</a></li>
                                        <?php $__currentLoopData = $menu_tintuc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/<?php echo e($tt['slug']); ?>"><?php echo e($tt['ten']); ?></a></li>
                        ...
                        <div class="col-md-6">
                            <ul class="sub-menu menu-border">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/tu-danh-gia-co-so-giao-duc">Tự đánh giá Cơ sở Giáo dục</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/tu-danh-gia-chuong-trinh-dao-tao">Tự đánh giá Chương trình Đào tạo</a></li>
                                        <li><a href="https://fms.agu.edu.vn/<?php echo e(app()->getLocale()); ?>" target="_blank">Hệ thống quản lý CSDL ĐBCL </a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/so-tay-dam-bao-chat-luong">Sổ tay Đảm bảo Chất lượng</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/giay-chung-nhan-dam-bao-chat-luong">Giấy chứng nhận Đảm bảo Chất lượng</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-md-6">
                            <ul class="sub-menu menu-border">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/nghien-cuu-khoa-hoc">Hoạt động Nghiên cứu Khoa học</a></li>
                        ...
                        <div class="col-md-6">
                            <ul class="sub-menu menu-border">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/hop-tac-quoc-te">Hợp tác Quốc tế</a></li>
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/doi-tac-ban-ghi-nho">Đối tác - Bản ghi nhớ</a></li>
                            ...
                            <ul class="sub-menu menu-border">
                                <li>
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/hoi-cuu-sinh-vien">Cựu sinh viên</a></li>
    ...
    <li>
        <a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/tin-tuc-su-kien/quy-che-cong-khai">Quy chế công khai</a>
    </li>
    <li><a href="https://lms.agu.edu.vn" target="_blank">LMS/LCMS</a></li>
</ul>
<?php /**PATH E:\Lara_Projects\AGU2026\resources\views/Frontend/menu_vi.blade.php ENDPATH**/ ?>