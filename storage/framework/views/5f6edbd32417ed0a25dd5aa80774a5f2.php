<?php $__env->startSection('title', __('Giới thiệu - Chính sách Đảm bảo Chất lượng')); ?>
    ...
    <div class="container">
        <div class="blog-single-details">
            ...
            <p class="text-justify" style="font-size:16px;">
                <img src="<?php echo e(env('APP_URL')); ?>assets/frontend/images/gioithieu/dam-bao-chat-luong.jpg" alt="Trường Đại học An Giang" style="float:left;width:500px;margin-right:20px;">
            ...
            <img src="<?php echo e(env('APP_URL')); ?>assets/frontend/images/gioithieu/phuong-cham-hoat-dong.jpg" alt="Trường Đại học An Giang" style="float:right;width:500px;margin-left:40px;">
            <ul class="list">
...
<?php echo $__env->make('Frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Lara_Projects\AGU2026\resources\views/Frontend/GioiThieu/chinh-sach-dam-bao-chat-luong-phuong-cham-hoat-dong.blade.php ENDPATH**/ ?>