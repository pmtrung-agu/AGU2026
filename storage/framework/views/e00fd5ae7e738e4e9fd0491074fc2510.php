...
<?php $__env->startSection('title', __('Thông tin Tuyển sinh')); ?>
...
<div class="row">
    <div class="col-12 card-box">
        <h3 class="m-t-0"><a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/admin/tuyen-sinh/thong-tin/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo e(__('Thêm mới')); ?></a> <?php echo e(__('Thông tin Tuyển sinh')); ?></h3>
        <hr />
        <form method="GET" action="<?php echo e(env('APP_URL') . app()->getLocale()); ?>/admin/tuyen-sinh/thong-tin">
            <div class="row form-group">
                ...
                <div class="col-12 col-md-4">
                    <select name="id_cat" class="form-control select2">
                        ...
                        <?php $__currentLoopData = $arr_cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php if($id_cat == $key): ?> selected <?php endif; ?>><?php echo e($cat); ?></option>
        ...
        <table class="table table-border table-bordered table-striped table-sm">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="<?php echo e(env('APP_URL')); ?>storage/images/origin/<?php echo e($ds['photos'][0]['aliasname']); ?>" class="image-popup">
                            <img src="<?php echo e(env('APP_URL')); ?>storage/images/thumb_50/<?php echo e($ds['photos'][0]['aliasname']); ?>" title="<?php echo e($ds['ho_ten']); ?>" alt="<?php echo e($ds['ho_ten']); ?>" style="height:20px;">
                        </a>
                        <?php else: ?>
                    ...
                    <td>
                        <a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/<?php if(app()->getLocale() == 'vi'): ?><?php echo e('tuyen-sinh/thong-tin'); ?><?php else: ?><?php echo e(('admissions/information')); ?><?php endif; ?>/<?php echo e($ds['slug']); ?>" target="_blank"><?php echo e($ds['ten']); ?></a>
                        <span style="font-size:10px;background:#ccc;padding:3px;"><?php echo e(App\Http\Controllers\ObjectController::getDate($ds['date_post'],"d/m/Y H:i")); ?></span>
                    </td>
                    <td class="text-center">
                        <?php if(isset($ds['published']) && $ds['published'] == 1): ?> <i class="fas fa-calendar-check text-primary"></i>
                        <?php else: ?> <i class="far fa-calendar-minus"></i>
                        <?php endif; ?>
                    </td>
                    <td class="text-center">
                        <?php if($ds['id_cat']): ?>
                        <div class="btn-group mb-2 dropleft" style="margin:0px !important;">
                            ...
                            <div class="dropdown-menu">
                                <?php $__currentLoopData = $ds['id_cat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/admin/tuyen-sinh/thong-tin?id_cat=<?php echo e($key); ?>" class="dropdown-item"><i class="fa fa-tag text-primary"></i> <?php echo e($arr_cats[$cat]); ?></a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                        <?php else: ?>
                        ...
                        ?>
                            <td class="text-center text-middle">
                                <?php if($transpath && isset($transpath['id_'.$klang])): ?>
                                    <a href="<?php echo e(env('APP_URL')); ?><?php echo e($klang); ?>/admin/tuyen-sinh/thong-tin/edit/<?php echo e($transpath["id_$klang"]); ?>?trans_id=<?php echo e($ds['_id']); ?>&trans_lang=<?php echo e(app()->getLocale()); ?>">
                                        <img src="<?php echo e(env('APP_URL')); ?>assets/backend/images/flags/<?php echo e($klang); ?>.jpg" alt="" class="flag-icon">
                                    </a>
                                <?php else: ?>
                                <a href="<?php echo e(env('APP_URL')); ?><?php echo e($klang); ?>/admin/tuyen-sinh/thong-tin/add?trans_id=<?php echo e($ds['_id']); ?>&trans_lang=<?php echo e(app()->getLocale()); ?>">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <td class="text-center">
                        <a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/admin/tuyen-sinh/thong-tin/delete/<?php echo e($ds['_id']); ?>" onclick="return confirm('Chắc chắc xóa?')"><i class="fas fa-trash text-danger"></i></a>&nbsp;
                        <a href="<?php echo e(env('APP_URL')); ?><?php echo e(app()->getLocale()); ?>/admin/tuyen-sinh/thong-tin/edit/<?php echo e($ds['_id']); ?>"><i class="fas fa-pencil-alt"></i></a>
                    </td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
            ...
            <?php if(isset($_SERVER['QUERY_STRING']) && $_SERVER['QUERY_STRING']): ?>
                <?php echo e($danhsach->withPath(env('APP_URL') . app()->getLocale() . '/admin/tuyen-sinh/thong-tin?' . $_SERVER['QUERY_STRING'])); ?>

            <?php else: ?>
                <?php echo e($danhsach->withPath(env('APP_URL') . app()->getLocale() . '/admin/tuyen-sinh/thong-tin')); ?>
...
<?php echo $__env->make('Admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Lara_Projects\AGU2026\resources\views/Admin/TuyenSinh/list.blade.php ENDPATH**/ ?>